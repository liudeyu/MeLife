...
import com.gzmelife.app.hhd.SearchsDetailActivity;
import com.gzmelife.app.tools.KappUtils;
import com.gzmelife.app.tools.MyLogger;
import com.gzmelife.app.tools.RecordSQLiteOpenHelper;
import com.gzmelife.app.hhd.TimeNode;
...
public class FoodssMangerSearchActivity extends BaseActivity implements
	...
	public static FoodssMangerSearchActivity fooddManger = null;
	...
	protected void onCreate(Bundle arg0) {
		...
		if (KappAppliction.getLiLogin() == 1) {
			...
			Intent intent = new Intent(FoodssMangerSearchActivity.this,
					LoginActivity.class);
	...
	private void initView() {
		...
		et_search.setOnKeyListener(new View.OnKeyListener() {// 输入完后按键盘上的搜索键
					...
					public boolean onKey(View v, int keyCode, KeyEvent event) {
						if (keyCode == KeyEvent.KEYCODE_ENTER
							...
							if (id == -1) {
								KappUtils.showToast(
										FoodssMangerSearchActivity.this,
										"搜索不到结果哦");
							} else {
								ArrayList<String> mList = FoodMaterialDAO
										.getAllFoodMaterialByCategoryIds(id);
								searchMenuBooks(mList, searchContent);
							}
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// searchMenuBook(name);
				int ids = FoodMaterialDAO.getCategoryIds(name);
				if (ids == -1) {
					KappUtils.showToast(FoodssMangerSearchActivity.this,
							"搜索不到结果哦");
				} else {
					ArrayList<String> mList = FoodMaterialDAO
							.getAllFoodMaterialByCategoryIds(ids);
					searchMenuBooks(mList, name);
				}
	...
	private void searchMenuBooks(ArrayList<String> threeList,
			String searchContent) {
		Intent intent = new Intent(FoodssMangerSearchActivity.this,
				SearchssDetailActivity.class);
		intent.putExtra("threesList", threeList);
